...
static const u8 sText_PkmnGainedEXP[] = _("{B_BUFF1} a gagné{B_BUFF2}\n{B_BUFF3} points d'EXP!\p");
static const u8 sText_EmptyString4[] = _("");
static const u8 sText_ABoosted[] = _(" un bonus");
static const u8 sText_PkmnGrewToLv[] = _("{B_BUFF1} monte au\nN. {B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_PkmnLearnedMove[] = _("{B_BUFF1} a appris\n{B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_TryToLearnMove1[] = _("{B_BUFF1} veut apprendre\nlearn {B_BUFF2}.\p");
static const u8 sText_TryToLearnMove2[] = _("Mais, {B_BUFF1} ne peut avoir\nplus de 4 attaques.\p");
static const u8 sText_TryToLearnMove3[] = _("Lui faire oublier\nune attaque pour {B_BUFF2}?");
static const u8 sText_PkmnForgotMove[] = _("{B_BUFF1} a oublié\n{B_BUFF2}.\p");
static const u8 sText_StopLearningMove[] = _("{PAUSE 32} Ne pas lui apprendre\n{B_BUFF2}?");
...
static const u8 sText_AvoidedDamage[] = _("{B_DEF_NAME_WITH_PREFIX} y est insensible\ngrâce à {B_DEF_ABILITY}!");
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} annule les\nattaques SOL avec {B_DEF_ABILITY}!");
static const u8 sText_PkmnAvoidedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} a évité\nl'attaque!");
static const u8 sText_ItDoesntAffect[] = _("ça n'affecte pas\n{B_DEF_NAME_WITH_PREFIX}…");
static const u8 sText_AttackerFainted[] = _("{B_ATK_NAME_WITH_PREFIX}\nest K.O!\p");
static const u8 sText_TargetFainted[] = _("{B_DEF_NAME_WITH_PREFIX}\nest K.O!\p");
static const u8 sText_PlayerGotMoney[] = _("{B_PLAYER_NAME} a remporté \n¥{B_BUFF1}!\p");
...
static const u8 sText_PreventsEscape[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} empêche\nla fuite avec {B_SCR_ACTIVE_ABILITY}!\p");
static const u8 sText_CantEscape2[] = _("Fuite impossible!\p");
static const u8 sText_AttackerCantEscape[] = _("{B_ATK_NAME_WITH_PREFIX} ne peut pas fuir!");
...
static const u8 sText_PkmnPoisonedBy[] = _("{B_EFF_NAME_WITH_PREFIX} est empoisonné par\n{B_BUFF1} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
...
static const u8 sText_TeamStoppedWorking[] = _("{B_BUFF1} de votre\néquipe disparait!");
...
static const u8 sText_PkmnWasConfused[] = _("{B_EFF_NAME_WITH_PREFIX} est\nconfus!");
...
static const u8 sText_PkmnMadeSubstitute[] = _("{B_ATK_NAME_WITH_PREFIX} créé\nun clone!");
static const u8 sText_PkmnHasSubstitute[] = _("{B_ATK_NAME_WITH_PREFIX} a déjà\nun clone!");
...
static const u8 sText_ItemsCantBeUsedNow[] = _("Vous ne pouvez pas utiliser\nd'objet.{PAUSE 64}");
...
const u8 gText_StatSharply[] = _("énormément ");
const u8 gText_StatRose[] = _("augmente!");
static const u8 sText_StatHarshly[] = _("énormément ");
...
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE SE_FLEE} sauvage {B_BUFF1} fuit!");
...
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} prend la fuite!");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} and\n{B_LINK_OPPONENT2_NAME} fled!");
static const u8 sText_NoRunningFromTrainers[] = _("On ne fuit pas d'un\ncombat de dresseurs!\p");
static const u8 sText_CantEscape[] = _("Fuite impossible!\p");
static const u8 sText_DontLeaveBirch[] = _("Prof. Shwartz : N'abandonne pas!\p");
...
static const u8 sText_StartedToRain[] = _("Il se met à pleuvoir!");
...
static const u8 sText_RainContinues[] = _("La pluie continue.");
...
static const u8 sText_SandstormBrewed[] = _("Une tempête de sable débute!");
static const u8 sText_SandstormRages[] = _("La tempête de sable fait rage.");
static const u8 sText_SandstormSubsided[] = _("La tempête de sable continue.");
static const u8 sText_SunlightGotBright[] = _("Le soleil se met à briller!");
static const u8 sText_SunlightStrong[] = _("Le soleil est intense.");
static const u8 sText_SunlightFaded[] = _("Le soleil se calme..");
...
static const u8 sText_TooWeakForSubstitute[] = _("Trop faible pour\nfaire un clone!");
static const u8 sText_SharedPain[] = _("Les combattants partagent\nleur souffrances!");
static const u8 sText_BellChimed[] = _("A bell chimed!");
static const u8 sText_FaintInThree[] = _("All affected POKéMON will\nfaint in three turns!");
static const u8 sText_NoPPLeft[] = _("Il n'y a plus de\nPP pour cette attaque!\p");
static const u8 sText_ButNoPPLeft[] = _("But there was no PP left\nfor the move!");
static const u8 sText_PkmnIgnoresAsleep[] = _("{B_ATK_NAME_WITH_PREFIX} vous ignore\net s'endort!");
static const u8 sText_PkmnIgnoredOrders[] = _("{B_ATK_NAME_WITH_PREFIX} ignore vos\nordres!");
...
static const u8 sText_LegendaryPkmnAppeared[] = _("Un {B_OPPONENT_MON1_NAME} sauvage apparait!\p");
...
static const u8 sText_DoItPkmn[] = _("Fais-le! {B_BUFF1}!");
...
static const u8 sText_PkmnThatsEnough[] = _("{B_BUFF1}, c'est suffisant!\nReviens!");
static const u8 sText_PkmnComeBack[] = _("{B_BUFF1}, reviens!");
static const u8 sText_PkmnOkComeBack[] = _("{B_BUFF1}, OK!\nReviens!");
static const u8 sText_PkmnGoodComeBack[] = _("{B_BUFF1}, fier de toi!\nReviens!");
...
static const u8 sText_WallyUsedItem[] = _("Dan utilise\n{B_LAST_ITEM}!");
static const u8 sText_Trainer1UsedItem[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nutilise {B_LAST_ITEM}!");
static const u8 sText_TrainerBlockedBall[] = _("Le dresseur contre la Pokéball!");
...
static const u8 sText_PkmnBrokeFree[] = _("Mince!\nLe Pokémon a brisé la Ball!");
...
static const u8 sText_PkmnDataAddedToDex[] = _("Les données de {B_DEF_NAME}\nsont ajoutées au Pokédex.\p");
static const u8 sText_ItIsRaining[] = _("Il pleut.");
static const u8 sText_SandstormIsRaging[] = _("A sandstorm is raging.");
static const u8 sText_BoxIsFull[] = _("La boite est pleine!\nImpossible de capturer plus!\p");
static const u8 sText_EnigmaBerry[] = _("ENIGMA BERRY");
static const u8 sText_BerrySuffix[] = _(" baie");
static const u8 sText_PkmnsItemCuredParalysis[] = _("{B_LAST_ITEM} soigne {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nde sa paralysie!");
static const u8 sText_PkmnsItemCuredPoison[] = _("{B_LAST_ITEM} soigne {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nde son empoisonnement!");
static const u8 sText_PkmnsItemHealedBurn[] = _("{B_LAST_ITEM} soigne {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nde sa brûlure!");
static const u8 sText_PkmnsItemDefrostedIt[] = _("{B_LAST_ITEM} dégêle {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nil peut de nouveau attaquer!");
static const u8 sText_PkmnsItemWokeIt[] = _("{B_LAST_ITEM} est utilisé sur {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nil se réveille!");
static const u8 sText_PkmnsItemSnappedOut[] = _("{B_LAST_ITEM} soigne {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nde sa confusion!");
...
static const u8 sText_YouThrowABallNowRight[] = _("Bon... Il est temps de la jeter.\nPo... Pokéball! GO!");
...
// New battle strings.
static const s8 sText_EnduredViaSturdy[] = _("{B_DEF_NAME_WITH_PREFIX} résiste\ngrâce à {B_DEF_ABILITY}!");
...
const u8 gText_PkmnStoppedEvolving[] = _("Quoi? {STR_VAR_1}\nn'évolue plus!\p");
const u8 gText_EllipsisQuestionMark[] = _("……?\p");
const u8 gText_WhatWillPkmnDo[] = _("Que doit faire\n{B_ACTIVE_NAME2}?");
const u8 gText_WhatWillPkmnDo2[] = _("Que va faire\n{B_PLAYER_NAME}?");
const u8 gText_WhatWillWallyDo[] = _("What will\nWALLY do?");
const u8 gText_LinkStandby[] = _("{PAUSE 16}Link standby…");
const u8 gText_BattleMenu[] = _("Attaque{CLEAR_TO 56}Sac\nÉquipe{CLEAR_TO 56}Fuir");
const u8 gText_SafariZoneMenu[] = _("BALL{CLEAR_TO 56}{POKEBLOCK}\nGO NEAR{CLEAR_TO 56}RUN");
const u8 gText_MoveInterfacePP[] = _("PP ");
const u8 gText_MoveInterfaceType[] = _("TYPE/");
const u8 gText_MoveInterfacePpType[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}PP\nTYPE/");
const u8 gText_MoveInterfaceDynamicColors[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}");
const u8 gText_WhichMoveToForget4[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Oublier quelle\n attaque?");
