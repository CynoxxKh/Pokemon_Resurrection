...
const u8 gText_ProfBirchMatchCallName[] = _("Prof. Shwartz");
...
const u8 gText_SaveFileCorrupted[] = _("Sauvegarde corrompue. La\nsauvegarde précédente sera chargée.");
...
ALIGNED(4) const u8 gText_Next[] = _("{A_BUTTON}Suivant"); // Unused
ALIGNED(4) const u8 gText_NextBack[] = _("{A_BUTTON}NEXT {B_BUTTON}Retour"); // Unused
ALIGNED(4) const u8 gText_PickNextCancel[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}NEXT {B_BUTTON}Retour");
ALIGNED(4) const u8 gText_PickCancel[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}{B_BUTTON}Retour");
...
const u8 gText_DefaultNameCamila[] = _("Camille");
...
const u8 gText_DefaultNameYasmin[] = _("Yasmine");
const u8 gText_DefaultNameNicola[] = _("Nicolas");
...
const u8 gText_ThisIsAPokemon[] = _("Voici un “POKéMON.”{PAUSE 96}\p");
...
const u8 gText_SizeComparedTo[] = _("Taille comparée à ");
const u8 gText_PokedexRegistration[] = _("Enregistré dans le Pokédex");
const u8 gText_HTHeight[] = _("TAILLE");
...
const u8 gText_DexHoennDescription[] = _("Pokédex d'Olnyris");
...
const u8 gText_WelcomeToHOF[] = _("Bienvenue au Panthéon!");
...
const u8 gMenuText_Register[] = _("Enregistrer");
...
const u8 gText_LvVar1[] = _("Nv{STR_VAR_1}");
...
const u8 gText_SpAtk4[] = _("Atq. Spé");
const u8 gText_SpDef4[] = _("Déf. Spé");
...
const u8 gText_ExpPoints[] = _("Points d'exp");
const u8 gText_NextLv[] = _("Prochain Nv.");
...
const u8 gText_PkmnInfo[] = _("Infos générales");
const u8 gText_PkmnSkills[] = _("Statistiques");
const u8 gText_BattleMoves[] = _("Attaques");
const u8 gText_ContestMoves[] = _("Concours");
const u8 gText_Info[] = _("Info");
const u8 gText_EggWillTakeALongTime[] = _("On dirait que cet oeuf\nn'est pas prêt d'éclore.");
const u8 gText_EggWillTakeSomeTime[] = _("What will hatch from this?\nIt will take some time.");
const u8 gText_EggWillHatchSoon[] = _("Il bouge de temps à autres.\nIl va bientôt éclore.");
const u8 gText_EggAboutToHatch[] = _("II fait des bruits.\nIl va éclore!");
const u8 gText_HMMovesCantBeForgotten2[] = _("Vous ne pouvez pas\noublier une CS.");
const u8 gText_XNatureMetAtYZ[] = _("Nature : {DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5},\nRencontré au {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1} à \n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
...
const u8 gText_DepositPokemon[] = _("Déposer Pokémon");
const u8 gText_MovePokemon[] = _("Déplacer Pokémon");
const u8 gText_MoveItems[] = _("Déplacer Objets");
const u8 gText_SeeYa[] = _("Déconnexion");
...
const u8 gText_CheckMapOfHoenn[] = _("Voir la carte d'Olnyris");
...
const u8 gText_TrainerCardMoney[] = _("SOLDE");
...
const u8 gText_MenuPokenav[] = _("V.N Tech");
...
const u8 gText_DexHoenn[] = _("Olnyris");
...
const u8 gText_Summary2[] = _("Infos");
...
const u8 gText_TrainerHill1F[] = _("E1");
const u8 gText_TrainerHill2F[] = _("E2");
const u8 gText_TrainerHill3F[] = _("E3");
const u8 gText_TrainerHill4F[] = _("E4");
...
const u8 gText_Confirm3[] = _("Confirmer");
...
const u8 gText_WallyMatchCallDesc[] = _("Pokémaniac");
